...
<script>
  $(document).ready(function () {
    $('#submit').click(function (e) {
      ...
      // Name Validation
      var name = $('#name').val();
      var nameRegex = /^[a-zA-Z\s]+$/; // Allow only alphabetic characters and spaces
      ...
      if (password === '' || password.length < 6 || password.length > 12) {
        alert('Please enter a strong password with a length between 6 and 12 characters.');
        isValid = false;
      ...
      var contactRegex = /^\d{10}$/; // 10-digit contact number validation
      ...
      // City, Area, and Role Validation
      var city = $('#city').val();
      var area = $('#area').val();
      var role = $('#role').val();
      if (city === '' || area === '' || role === '') {
        alert('Please select City, Area, and Role.');
        isValid = false;
      }
