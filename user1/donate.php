...
if (isset($_POST['submit'])) {
    ...
    $exe = $obj->query("INSERT INTO money_donation (user_id, amount, description, date, d_name, cert_no) 
                        VALUES ('$user_id', '$amt', '$desc', '$date', '$d_name', '$cert')");
